...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="flex py-5 bg-indigo-500 text-white">
        <div class="w-1/2 px-12 mr-auto">
            <p class="text-2x1 font-bold">Mi Aplicación</p>
        </div>
        ...
        <?php else: ?>
            ...
            <li>
                <a href="<?php echo e(route('inicio.index')); ?>"class="font-semibold
                border-2 border-white py-2 px-4 rounded-md hover:bg-white
...
</html><?php /**PATH C:\xampp\htdocs\QR_Code\resources\views/layouts/app.blade.php ENDPATH**/ ?>