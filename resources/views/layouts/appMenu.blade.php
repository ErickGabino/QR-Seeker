...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;>
	...
	<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a href="{{ route('registerAd.index') }}" class="dropdown-item">Registrar Administrador</a>
		<div class="dropdown-divider"></div>
        <a class="dropdown-item" href="{{ route('consultaAd.index') }}">Ver Administradores</a>
        </div>
    </li>
	...
	<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        <a class="dropdown-item" href="{{ route('registerProduc.index') }}">Registrar Producto</a>
		<div class="dropdown-divider"></div>
        <a class="dropdown-item" href="{{ route('consultaProd.index') }}">Ver Productos</a>
        </div>
    </li>
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a href="{{ route('sucursal.index') }}" class="dropdown-item">Registrar Sucursal</a>
		<div class="dropdown-divider"></div>
        <a class="dropdown-item" href="{{ route('consultaSuc.index') }}">Ver Sucursales</a>
        </div>
    </li>
    </ul>
        <form class="d-flex flex-row-reverse bd-highlight">

    <button class="btn btn-outline-danger" type="submit"><a href="{{ route('login.destroy') }}" class="text-danger"> Cerrar Sesion</a></button>
